...
#
	...
	PreferencesDialog = Preferences(None, self)
	
	# Check number of monitors
	if wx.Display.GetCount()>1 and self.IsFullScreen():
		if wx.Display.GetFromWindow(self) == 0:
        ...
        PrefDiag = PreferencesDialog.ShowModal()
        if PrefDiag == wx.ID_OK:
                # Reload settings
		self.LoadSettings(self)
